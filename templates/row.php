...
<span class="edit"><a href="<?php echo admin_url(); ?>?page=myLCO_edit&amp;cl={cl}&amp;action=check&url={backlink_url}"><?php _e( 'Check', 'myLCO' ); ?></a> | </span>
<span class="trash"><a class="submitdelete" href="<?php echo admin_url(); ?>?page=myLCO_edit&amp;cl={cl}&amp;action=delete&url={backlink_url}" onclick="if (confirm ('{DeleteMessage}')) { return true; } return false;"><?php _e( 'Delete', 'myLCO' ); ?></a></span>
</div>
