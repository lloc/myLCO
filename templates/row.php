...
<span class="edit"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?page=myLCO_edit&amp;cl=<?php echo $_REQUEST['cl']; ?>&amp;action=check&url={backlink_url}"><?php _e ('Check', _MYLCO_); ?></a> | </span>
<span class="trash"><a class="submitdelete" href="<?php echo $_SERVER['PHP_SELF']; ?>?page=myLCO_edit&amp;cl=<?php echo $_REQUEST['cl']; ?>&amp;action=delete&url={backlink_url}" onclick="if (confirm ('{DeleteMessage}')) { return true; } return false;"><?php _e ('Delete', _MYLCO_); ?></a></span>
</div>
